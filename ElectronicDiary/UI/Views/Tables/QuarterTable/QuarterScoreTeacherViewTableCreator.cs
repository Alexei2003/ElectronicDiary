                ...
                if (!string.IsNullOrEmpty(response))
                {
                    ...
                    if (!string.IsNullOrEmpty(response))
                    {
                        ...
                        foreach (var score in quarterArr)
                        {
                            ...
                            {
                                if (_headerRowArr[i] == (score?.SchoolStudentId ?? 0))
                                {
                                    row = i;
                                }
                            }
